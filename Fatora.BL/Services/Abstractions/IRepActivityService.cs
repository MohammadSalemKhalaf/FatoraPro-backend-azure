...
public interface IRepActivityService
{
    ...
    // Every rep-created Order/Receipt/PurchaseRequest (preparing or ready
    // only) across all of this owner's reps from the last 24 hours, newest
    // first - a rolling window, not a fixed day: an item simply stops
    // appearing once it's more than 24 hours old, no matter when this is
    // called.
